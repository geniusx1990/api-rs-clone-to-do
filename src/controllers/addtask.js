...
exports.addtask = async (req, res) => {
    ...
    try {
        const newTask = await client.query(`INSERT INTO tasks (title, content, completed, user_id) values ($1, $2, $3, $4) RETURNING *`, [title, content, completed, user_id]) //Inserting data into tasks table
